...
float _Gimmick_ZWrite_Abomination_Min_Hit_Dist;
float _Gimmick_ZWrite_Abomination_March_Steps;
...
float3 _Gimmick_ZWrite_Abomination_Denim_Center;
float _Gimmick_ZWrite_Abomination_Denim_Strap_Theta;
float _Gimmick_ZWrite_Abomination_Denim_Strap_RA;
float _Gimmick_ZWrite_Abomination_Denim_Strap_RB;
float3 _Gimmick_ZWrite_Abomination_Denim_Strap_Center;
float _Gimmick_ZWrite_Abomination_Denim_Strap_Z_Theta;
float _Gimmick_ZWrite_Abomination_Lens_Radius;
float _Gimmick_ZWrite_Abomination_Lens_Depth;
float _Gimmick_ZWrite_Abomination_Lens_Thickness;
float _Gimmick_ZWrite_Abomination_Lens_Strap_Height;
float _Gimmick_ZWrite_Abomination_Pupil_Radius;
float3 _Gimmick_ZWrite_Abomination_Eye_Center;
float3 _Gimmick_ZWrite_Abomination_Arm_Center;
float _Gimmick_ZWrite_Abomination_Arm_Radius;
float _Gimmick_ZWrite_Abomination_Arm_Half_Length;
float3 _Gimmick_ZWrite_Abomination_Leg_Center;
float _Gimmick_ZWrite_Abomination_Leg_Radius;
float _Gimmick_ZWrite_Abomination_Leg_Half_Length;
float3 _Gimmick_ZWrite_Abomination_Mouth_Center;
float _Gimmick_ZWrite_Abomination_Mouth_Theta;
float _Gimmick_ZWrite_Abomination_Mouth_RA;
float _Gimmick_ZWrite_Abomination_Mouth_RB;
float4 _Gimmick_ZWrite_Abomination_Skin_Color;
float _Gimmick_ZWrite_Abomination_Skin_Metallic;
float _Gimmick_ZWrite_Abomination_Skin_Roughness;
float4 _Gimmick_ZWrite_Abomination_Lens_Color;
float _Gimmick_ZWrite_Abomination_Lens_Metallic;
float _Gimmick_ZWrite_Abomination_Lens_Roughness;
float4 _Gimmick_ZWrite_Abomination_Denim_Color;
float _Gimmick_ZWrite_Abomination_Denim_Metallic;
float _Gimmick_ZWrite_Abomination_Denim_Roughness;
float4 _Gimmick_ZWrite_Abomination_Lens_Strap_Color;
float _Gimmick_ZWrite_Abomination_Lens_Strap_Metallic;
float _Gimmick_ZWrite_Abomination_Lens_Strap_Roughness;
#endif
